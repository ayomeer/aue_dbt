...
<qgis simplifyAlgorithm="0" version="3.22.11-Białowieża" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" symbologyReferenceScale="-1" minScale="100000000" maxScale="0" labelsEnabled="0" readOnly="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1">
      ...
      <symbol type="fill" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="202,139,76,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="hm_typ" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="hm_ke" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="kt_hochmoor_teilobjekt" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="hm_typ" index="4"/>
    <alias name="" field="hm_ke" index="5"/>
    <alias name="" field="kt_hochmoor_teilobjekt" index="6"/>
  </aliases>
  <defaults>
    ...
    <default field="hm_typ" expression="" applyOnUpdate="0"/>
    <default field="hm_ke" expression="" applyOnUpdate="0"/>
    <default field="kt_hochmoor_teilobjekt" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" unique_strength="0" field="hm_typ" exp_strength="0"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" field="hm_ke" exp_strength="0"/>
    <constraint constraints="1" notnull_strength="1" unique_strength="0" field="kt_hochmoor_teilobjekt" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="hm_typ" desc="" exp=""/>
    <constraint field="hm_ke" desc="" exp=""/>
    <constraint field="kt_hochmoor_teilobjekt" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="hm_typ" hidden="0" width="-1"/>
      <column type="field" name="hm_ke" hidden="0" width="-1"/>
      <column type="field" name="kt_hochmoor_teilobjekt" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="hm_ke" editable="1"/>
    <field name="hm_typ" editable="1"/>
    <field name="kt_hochmoor_teilobjekt" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="hm_ke" labelOnTop="0"/>
    <field name="hm_typ" labelOnTop="0"/>
    <field name="kt_hochmoor_teilobjekt" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="hm_ke" reuseLastValue="0"/>
    <field name="hm_typ" reuseLastValue="0"/>
    <field name="kt_hochmoor_teilobjekt" reuseLastValue="0"/>
