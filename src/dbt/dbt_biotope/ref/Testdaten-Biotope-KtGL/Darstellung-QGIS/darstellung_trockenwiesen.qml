...
<qgis simplifyAlgorithm="0" version="3.22.11-Białowieża" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" symbologyReferenceScale="-1" minScale="100000000" maxScale="0" labelsEnabled="0" readOnly="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1">
      ...
      <symbol type="fill" name="0" alpha="1" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="255,76,76,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="bewertungseinheit" configurationFlags="None">
    ...
    <field name="teilobjekt" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
    ...
    <field name="kt_trockenwiese" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="bewertungseinheit" index="5"/>
    <alias name="" field="teilobjekt" index="6"/>
    <alias name="" field="kt_trockenwiese" index="7"/>
  </aliases>
  <defaults>
    ...
    <default field="bewertungseinheit" expression="" applyOnUpdate="0"/>
    <default field="teilobjekt" expression="" applyOnUpdate="0"/>
    <default field="kt_trockenwiese" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" unique_strength="0" field="bewertungseinheit" exp_strength="0"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" field="teilobjekt" exp_strength="0"/>
    <constraint constraints="1" notnull_strength="1" unique_strength="0" field="kt_trockenwiese" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="bewertungseinheit" desc="" exp=""/>
    <constraint field="teilobjekt" desc="" exp=""/>
    <constraint field="kt_trockenwiese" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="bewertungseinheit" hidden="0" width="-1"/>
      <column type="field" name="teilobjekt" hidden="0" width="-1"/>
      <column type="field" name="kt_trockenwiese" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="kt_trockenwiese_t_ili_tid" editable="0"/>
  ...
  <labelOnTop>
    ...
    <field name="kt_trockenwiese_t_ili_tid" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="kt_trockenwiese_t_ili_tid" reuseLastValue="0"/>
